    ...
    project.dashboards.each do |dashboard|
      ...
      misspelled_words.each do |misspelled_word|
        ...
        err_array.push(error_details = {
            ...
            :title => 'Misspelled word '+ misspelled_word[:error] +' in dashboards name '+ dashboard.title,
      ...
      dashboard.tabs.each do |tab|
        ...
        misspelled_words.each do |misspelled_word|
          ...
          err_array.push(error_details = {
              ...
              :api => server + dashboard.uri,
              :title => 'Misspelled word '+ misspelled_word[:error] +' in tab name '+ dashboard.title + ' - ' + tab.title,
              :description => 'Suggestion: ' + misspelled_word[:suggestions]
          })
        end
      end
    ...
    project.metrics.each do |metric|
      ...
      misspelled_words.each do |misspelled_word|
        ...
        err_array.push(error_details = {
            ...
            :title => 'Misspelled word '+ misspelled_word[:error] +' in metric name '+ metric.title,
            :description => 'Suggestion: ' + misspelled_word[:suggestions]
        })
      end
    end
    ...
    project.reports.each do |report|
      ...
      misspelled_words.each do |misspelled_word|
        ...
        err_array.push(error_details = {
            ...
            :title => 'Misspelled word '+ misspelled_word[:error] +' in project name '+ report.title,
            :description => 'Suggestion: ' + misspelled_word[:suggestions]
        })
      end
    end
    ...
    project.facts.each do |fact|
      ...
      misspelled_words.each do |misspelled_word|
        ...
        err_array.push(error_details = {
            ...
            :api => server + fact.uri,
            :title => 'Misspelled word '+ misspelled_word[:error] +' in fact name '+ fact.title,
            :description => 'Suggestion: ' + misspelled_word[:suggestions]
        })
      end
    end
    ...
    project.attributes.each do |attribute|
      ...
      misspelled_words.each do |misspelled_word|
        ...
        err_array.push(error_details = {
            ...
            :title => 'Misspelled word '+ misspelled_word[:error] +' in project name '+ attribute.title,
            :description => 'Suggestion: ' + misspelled_word[:suggestions]
        })
      end
    end
    ...
    project.datasets.each do |dataset|
      ...
      misspelled_words.each do |misspelled_word|
        ...
        err_array.push(error_details = {
            ...
            :title => 'Misspelled word '+ misspelled_word[:error] +' in dataset name '+ dataset.title,
            :description => 'Suggestion: ' + misspelled_word[:suggestions]
        })
      end
    end
